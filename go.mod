module iag-procurement/backend
...
// Meta-repo local dev. Standalone Railway/CI/Dockerfile replaces with
// third_party/platform-go (see Dockerfile and scripts/sync-platform-go.sh).
