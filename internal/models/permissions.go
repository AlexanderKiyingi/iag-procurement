...
func PermissionDescriptors() []PermissionDescriptor {
	return []PermissionDescriptor{
		...
		{Name: "procurement.approve_requisition_tier1", Description: "Approve requisitions at tier 1 (lowest amount band)"},
		{Name: "procurement.approve_requisition_tier2", Description: "Approve requisitions at tier 2 (mid amount band)"},
		{Name: "procurement.approve_requisition_tier3", Description: "Approve requisitions at tier 3 (highest amount band)"},
