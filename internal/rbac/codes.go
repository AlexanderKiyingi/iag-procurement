...
const (
	...
	// ManageApprovalChains gates edits to the desk matrix in
	// requisition_approval_desks — who holds which desk, in what order, and
	// from what amount each engages. Changing it re-routes every future
	// approval, so it is deliberately separate from approving anything.
	ManageApprovalChains = "procurement.manage_approval_chains"
